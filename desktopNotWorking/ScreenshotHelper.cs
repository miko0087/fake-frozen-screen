...
namespace desktopNotWorking
{
    ...
    {
        public static Image GetBitmapScreenshot(Screen screen)
        {
            Image img = null;
            ...
            Thread t = new Thread(new ThreadStart(screenshot));
            
            void screenshot()
            {
                Form ScreenshotWindow = new invisibleWindow();
                ScreenshotWindow.Focus();
                ScreenshotWindow.Size = new Size(screen.Bounds.Width, screen.Bounds.Height);
                ScreenshotWindow.Location = new Point(screen.WorkingArea.X, screen.WorkingArea.Y);
                ScreenshotWindow.AllowTransparency = true;
                ScreenshotWindow.Opacity = 0;
